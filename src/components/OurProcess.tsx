            ...
            >
              ...
              <div className="relative rounded-xl overflow-hidden bg-black/60 ring-1 ring-white/10">
                ...
                <div className="relative z-10 flex flex-col">
                  {/* Stage */}
                  <div className="flex items-center gap-2 px-3 pt-3 text-[11px] tracking-[0.16em] text-white/80">
                    <span className="inline-grid h-4 w-4 place-items-center rounded bg-white/10 text-[10px]">
                      ▦
                    </span>
                    {s.stage}
                  </div>
              ...
              {/* Bottom Card (EQUAL HEIGHT) */}
              <div className="mt-3 flex flex-col flex-1 rounded-xl bg-white text-[#111] ring-1 ring-black/10 p-4 md:p-5 shadow-[0_10px_25px_rgba(0,0,0,0.15)]">
                <div className="mb-2 flex items-center gap-2 text-[11px] tracking-[0.16em] text-black/60">
                  <span className="inline-grid h-4 w-4 place-items-center rounded bg-black/5 text-[10px]">
                    ▦
                  </span>
                  {s.stage}
                </div>
                ...
                <p className="mt-2 text-sm leading-relaxed text-black/70 flex-1">
                  {s.blurb}
                </p>
              </div>
            </motion.article>
